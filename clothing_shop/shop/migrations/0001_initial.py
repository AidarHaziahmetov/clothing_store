    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('manager', 'Менеджер'), ('customer', 'Клиент')], default='customer', max_length=20, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('processing', 'В обработке'), ('shipped', 'Отправлен'), ('completed', 'Завершен'), ('canceled', 'Отменен')], default='processing', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(related_name='clothes', to='shop.category', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(choices=[('XS', 'XS'), ('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL'), ('XXL', 'XXL'), ('XXXL', 'XXXL')], max_length=4, verbose_name='Размер')),
